...
public class MainActivity extends AppCompatActivity
    ...
    private void setCount() {
        ...
        int unfinishNum=noteDao.countType(login_user,0);//未完成笔记
        int finishNum=noteDao.countType(login_user,1);//已完成笔记
        int allNum = finishNum+unfinishNum;//所有笔记
        ...
        String all_before = "所有笔记";
        String finish_before = "已完成笔记";
        String unfinish_before = "未完成笔记";
    ...
    public boolean onContextItemSelected(MenuItem item){
        ...
        switch (item.getItemId()){
            ...
            case Menu.FIRST+4://标记为已完成
                ...
                if(bean.getMark()==1){
                    Toast.makeText(MainActivity.this,"它已被完成了啊！", Toast.LENGTH_SHORT).show();
                }else{
                    bean.setMark(1);
            ...
            case Menu.FIRST+5://标记为未完成
                ...
                if(bean2.getMark()==0){
                    Toast.makeText(MainActivity.this,"它本就没完成啊！", Toast.LENGTH_SHORT).show();
                }else{
                    bean2.setMark(0);
